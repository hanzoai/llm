...
class RedisCache(BaseCache):
    ...
    def increment_cache(
        ...
        try:
            ...
            _duration = end_time - start_time
            verbose_logger.error(
                "LLM Redis Caching: increment_cache() - Got exception from REDIS %s, Writing value=%s",
                str(e),
                value,
            )
            raise e
    ...
    async def async_set_cache(self, key, value, **kwargs):
        ...
        try:
            ...
            verbose_logger.error(
                "LLM Redis Caching: async set() - Got exception from REDIS %s, Writing value=%s",
                str(e),
                value,
            )
            raise e
    ...
    async def async_set_cache_pipeline(
        ...
        try:
            ...
            verbose_logger.error(
                "LLM Redis Caching: async set_cache_pipeline() - Got exception from REDIS %s, Writing value=%s",
                str(e),
                cache_value,
            )
    ...
    async def async_set_cache_sadd(
        ...
        try:
            ...
            # NON blocking - notify users Redis is throwing an exception
            verbose_logger.error(
                "LLM Redis Caching: async set_cache_sadd() - Got exception from REDIS %s, Writing value=%s",
                str(e),
                value,
            )
    ...
    async def async_increment(
        ...
        try:
            ...
            verbose_logger.error(
                "LLM Redis Caching: async async_increment() - Got exception from REDIS %s, Writing value=%s",
                str(e),
                value,
            )
            raise e
    ...
    def sync_ping(self) -> bool:
        ...
        try:
            ...
            verbose_logger.error(
                f"LLM Redis Cache PING: - Got exception from REDIS : {str(e)}"
            )
            raise e
    ...
    async def async_increment_pipeline(
        ...
        try:
            ...
            verbose_logger.error(
                "LLM Redis Caching: async increment_pipeline() - Got exception from REDIS %s",
                str(e),
            )
            raise e
