...
from llm.exceptions import HanzoUnknownProvider
...
def completion(  # type: ignore # noqa: PLR0915
    ...
    **kwargs,
    ...
    if isinstance(llm_logging_obj, HanzoLoggingObj) and prompt_id is not None:
    ...
    try:
        ...
        if custom_llm_provider == "azure":
            ...
            api_base = api_base or llm.api_base or "https://openrouter.ai/api/v1"
...
def embedding(  # noqa: PLR0915
    ...
    **kwargs,
    ...
    max_retries = kwargs.get("max_retries", None)
    llm_logging_obj: HanzoLoggingObj = kwargs.get("llm_logging_obj")  # type: ignore
    ...
    *args, **kwargs
    ...
    try:
        ...
        if (
            ...
            text_completion_response = llm.utils.HanzoResponseObjectHandler.convert_chat_to_text_completion(
...
def text_completion(  # noqa: PLR0915
    ...
    **kwargs,
    ...
    text_completion_response = (
        llm.utils.HanzoResponseObjectHandler.convert_chat_to_text_completion(
            response=response,
            text_completion_response=text_completion_response,
        )
    )
...
def image_variation(
    ...
    **kwargs,
    ...
    client = kwargs.get("client", None)
    # get logging object
    llm_logging_obj = cast(HanzoLoggingObj, kwargs.get("llm_logging_obj"))
...
def speech(  # noqa: PLR0915
    ...
    **kwargs,
    ...
    if (
        ...
        generic_optional_params = GenericHanzoParams(**kwargs)
...
async def ahealth_check(
    ...
    try:
        ...
        mode_handlers = {
            "chat": lambda: llm.acompletion(**model_params),
        ...
        error_to_return = (
            str(e)
            + "\nHave you set 'mode' - https://docs.llm.ai/docs/proxy/health#embedding-models"
            + "\nstack trace: "
            + stack_trace
        )
