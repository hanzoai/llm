...
# import pytest
# import llm
# from llm import embedding, completion, text_completion, completion_cost
...
# def test_chat_gpt():
#     try:
#         chat = ChatHanzo(model="gpt-3.5-turbo", max_tokens=10)
#         messages = [
#             HumanMessage(
...
# def test_claude():
#     try:
#         chat = ChatHanzo(model="claude-2", max_tokens=10)
#         messages = [
#             HumanMessage(
#                 content="what model are you"
#             )
