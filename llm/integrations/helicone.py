...
class HeliconeLogger:
    ...
    def log_success(
        ...
        try:
            ...
            if isinstance(response_obj, llm.EmbeddingResponse) or isinstance(
            ...
            response = llm.module_level_client.post(url, headers=headers, json=data)
