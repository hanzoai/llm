...
from llm.types.utils import TextChoices
from llm.utils import CustomStreamWrapper, TextCompletionResponse
...
class CodestralTextCompletion:
    ...
    def completion(
        ...
        ## Load Config
        config = llm.CodestralTextCompletionConfig.get_config()
