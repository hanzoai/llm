...
from llm.types.llms.databricks import GenericStreamingChunk
...
class CodestralTextCompletionConfig(OpenAITextCompletionConfig):
    ...
    def _chunk_parser(self, chunk_data: str) -> GenericStreamingChunk:
        ...
        chunk_data = (
            llm.CustomStreamWrapper._strip_sse_data_from_chunk(chunk_data) or ""
        )
        ...
        original_chunk = llm.ModelResponse(**chunk_data_dict, stream=True)
