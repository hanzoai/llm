export type Hanzo_IncrementSpend = {
    key_transactions: Array<Hanzo_IncrementObject>, // [{"key": spend},..]
    user_transactions: Array<Hanzo_IncrementObject>, 
    team_transactions: Array<Hanzo_IncrementObject>,
    spend_logs_transactions: Array<Hanzo_SpendLogs>
}

export type Hanzo_IncrementObject = {
    key: string,
    spend: number
}

export type Hanzo_SpendLogs = {
