...
from llm.types.guardrails import DynamicGuardrailParams, GuardrailEventHooks
from llm.types.utils import StandardLoggingGuardrailInformation
...
class CustomGuardrail(CustomLogger):
    ...
    def get_guardrail_dynamic_request_body_params(self, request_data: dict) -> dict:
        ...
        Args:
            request_data: The original `request_data` passed to Hanzo Proxy
        """
    ...
    def add_standard_logging_guardrail_information_to_request_data(
        ...
        elif "llm_metadata" in request_data:
            request_data["llm_metadata"][
