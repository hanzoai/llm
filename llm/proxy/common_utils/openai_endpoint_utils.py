...
def remove_sensitive_info_from_deployment(deployment_dict: dict) -> dict:
    ...
    """
    deployment_dict["llm_params"].pop("api_key", None)
    deployment_dict["llm_params"].pop("vertex_credentials", None)
    deployment_dict["llm_params"].pop("aws_access_key_id", None)
    deployment_dict["llm_params"].pop("aws_secret_access_key", None)
