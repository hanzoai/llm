...
1. **User Sends Request**: The process begins when a user sends a request to the Hanzo Router endpoint. All unified endpoints (`.completion`, `.embeddings`, etc) are supported by Hanzo Router.
