...
from llm.proxy._types import CommonProxyErrors, KeyManagementSystem
...
class GoogleSecretManager(GCSBucketBase):
    def __init__(
        ...
        llm.secret_manager_client = self
        llm._key_management_system = KeyManagementSystem.GOOGLE_SECRET_MANAGER
