...
def main(argv=None):
    print(
        "Comparing model_prices_and_context_window and llm/model_prices_and_context_window_backup.json files... checking if they match."
    )

    file1 = "model_prices_and_context_window.json"
    file2 = "llm/model_prices_and_context_window_backup.json"
