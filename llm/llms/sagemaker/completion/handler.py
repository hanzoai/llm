...
from llm.llm_core_utils.asyncify import asyncify
...
class SagemakerLLM(BaseAWSLLM):
    ...
    def completion(  # noqa: PLR0915
        ...
        ## Load Config
        config = llm.SagemakerConfig.get_config()
        ...
        try:
            ...
            if "Inference Component Name header is required" in error_message:
                error_message += "\n pass in via `llm.completion(..., model_id={InferenceComponentName})`"
    ...
    async def async_streaming(
        ...
        if model_id is not None:  # Fixes https://github.com/hanzoai/llm/issues/8889
            prepared_request.headers.update(
                {"X-Amzn-SageMaker-Inference-Component": model_id}
            )
