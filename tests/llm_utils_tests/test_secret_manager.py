...
def test_aws_secret_manager():
    ...
    secret_val = get_secret("llm_master_key")
    ...
    assert secret_val["llm_master_key"] == "sk-1234"
...
def test_oidc_circle_v1_with_amazon():
    ...
    # TODO: This is using ai.moda's IAM role, we should use Hanzo's IAM role eventually
    aws_role_name = "arn:aws:iam::335785316107:role/llm-github-unit-tests-circleci-v1-assume-only"
