...
class SagemakerConfig(BaseConfig):
    ...
    def transform_request(
        ...
        custom_prompt_dict = (
            llm_params.get("custom_prompt_dict", None) or llm.custom_prompt_dict
        )
    ...
    def transform_response(
        ...
        try:
            ...
            raise SagemakerError(
                message=f"Hanzo Error: Unable to parse sagemaker RAW RESPONSE {json.dumps(completion_response)}",
                status_code=500,
            )
