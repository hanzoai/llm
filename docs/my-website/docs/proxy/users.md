...
LLM exposes a `/user/new` endpoint to create budgets for this.
...
**Expected Behaviour**
- Costs Per key get auto-populated in `LLM_VerificationToken` Table
...
{
    "error": {
        "message": "LLM Virtual Key: 9769f3f6768a199f76cc29xxxx, key_alias: None, exceeded budget for model=gpt-4o",
