...
from llm.proxy.utils import log_db_metrics, ServiceTypes
...
async def test_log_db_metrics_success():
    ...
    with patch("llm.proxy.proxy_server.proxy_logging_obj") as mock_proxy_logging:
        # Setup mock
...
async def test_dd_log_db_spend_failure_metrics():
    ...
    with patch.object(dd_logger, "async_service_failure_hook", new_callable=AsyncMock):
        ...
        llm.service_callback = [dd_logger]
