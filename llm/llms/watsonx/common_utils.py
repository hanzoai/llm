...
from llm.llm_core_utils.prompt_templates import factory as ptf
...
from llm.types.llms.watsonx import WatsonXAPIParams, WatsonXCredentials
...
class IBMWatsonXMixin:
    ...
    def _add_api_version_to_url(self, url: str, api_version: Optional[str]) -> str:
        api_version = api_version or llm.WATSONX_DEFAULT_API_VERSION
