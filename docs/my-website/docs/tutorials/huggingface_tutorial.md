...
Hanzo makes it easy to call your public, private or the default huggingface endpoints. 
...
messages = [{"role": "user", "content": "Hey, how's it going?"}] # Hanzo follows the OpenAI format 
...
What's happening? 
- api_base: Optional param. Since this uses a deployed endpoint (not the [default huggingface inference endpoint](https://github.com/BerriAI/llm/blob/6aff47083be659b80e00cb81eb783cb24db2e183/llm/llms/huggingface_restapi.py#L35)), we pass that to Hanzo. 
...
On Hanzo there's 3 ways you can pass in an api_key. 
