...
from llm.responses.streaming_iterator import (
    BaseResponsesAPIStreamingIterator,
    ResponsesAPIStreamingIterator,
    SyncResponsesAPIStreamingIterator,
)
from llm.types.llms.openai import ResponseInputParam, ResponsesAPIResponse
from llm.types.rerank import OptionalRerankParams, RerankResponse
from llm.types.router import GenericHanzoParams
from llm.types.utils import EmbeddingResponse, FileTypes, TranscriptionResponse
...
class BaseLLMHTTPHandler:
    ...
    def make_sync_call(
        ...
        if client is None or not isinstance(client, HTTPHandler):
            sync_httpx_client = _get_httpx_client(
                {
                    "ssl_verify": llm_params.get("ssl_verify", None),
                }
            )
        else:
            sync_httpx_client = client
    ...
    def audio_transcriptions(
        ...
        if isinstance(provider_config, llm.DeepgramAudioTranscriptionConfig):
