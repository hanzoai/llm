...
from llm.types.integrations.langsmith import *
...
class LangsmithLogger(CustomBatchLogger):
    def __init__(
        ...
        **kwargs,
        ...
        _batch_size = (
            os.getenv("LANGSMITH_BATCH_SIZE", None) or llm.langsmith_batch_size
        )
        if _batch_size:
    ...
    def _prepare_log_data(
        ...
        try:
            ...
            metadata = _llm_params.get("metadata", {}) or {}
            ...
            data = {
                "name": run_name,
                "run_type": "llm",  # this should always be llm, since llm always logs llm calls. Langsmith allow us to log "chain"
                "inputs": payload,
