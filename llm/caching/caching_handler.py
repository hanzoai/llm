...
class LLMCachingHandler:
    ...
    def _async_log_cache_hit_on_callbacks(
        ...
        Args:
            logging_obj (LLMLoggingObj): The logging object.
    ...
    def _update_llm_logging_obj_environment(
        ...
        """
        Helper function to update the LLMLoggingObj environment variables.

        Args:
            logging_obj (LLMLoggingObj): The logging object to update.
