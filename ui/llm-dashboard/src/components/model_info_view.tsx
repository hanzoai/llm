              ...
              <Form
                ...
                initialValues={{
                  ...
                  input_cost: localModelData.llm_params?.input_cost_per_token ? 
                    (localModelData.llm_params.input_cost_per_token * 1_000_000) : modelData.input_cost * 1_000_000,
                  output_cost: localModelData.llm_params?.output_cost_per_token ? 
                    (localModelData.llm_params.output_cost_per_token * 1_000_000) : modelData.output_cost * 1_000_000,
                }}
                layout="vertical"
              ...
              >
                <div className="space-y-4">
                  <div className="space-y-4">
                    ...
                    <div>
                      <Text className="font-medium">Hanzo Model Name</Text>
                      {isEditing ? (
                        <Form.Item name="llm_model_name" className="mb-0">
                          <TextInput placeholder="Enter Hanzo model name" />
                        </Form.Item>
                      ) : (
