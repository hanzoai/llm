...
from llm.types.rerank import OptionalRerankParams, RerankBilledUnits, RerankResponse
from llm.types.utils import ModelInfo
...
class BaseRerankConfig(ABC):
    ...
    def calculate_rerank_cost(
        ...
        Input:
            ...
            - custom_llm_provider: str, the provider used for the model. If provided, used to check if the llm model info is for that provider.
