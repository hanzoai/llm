...
async def add_new_member(
...
) -> Tuple[LLM_UserTable, Optional[LLM_TeamMembership]]:
    """
    ...
    """
    returned_user: Optional[LLM_UserTable] = None
    returned_team_membership: Optional[LLM_TeamMembership] = None
    ...
    if (
        ...
        returned_team_membership = LLM_TeamMembership(
