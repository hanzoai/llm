...
Use this if you want to use an Oauth2.0 token to make `/chat`, `/embeddings` requests to the LLM Proxy
...
3. Use token in requests to LLM 
...
Start the LLM Proxy with [`--detailed_debug` mode and you should see more verbose logs](cli.md#detailed_debug)
