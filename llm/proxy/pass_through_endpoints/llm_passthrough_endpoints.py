...
Use llm with Anthropic SDK, Vertex AI SDK, Cohere SDK, etc.
"""
...
from llm.constants import BEDROCK_AGENT_RUNTIME_PASS_THROUGH_ROUTES
...
async def bedrock_proxy_route(
    ...
    aws_region_name = llm.utils.get_secret(secret_name="AWS_REGION_NAME")
