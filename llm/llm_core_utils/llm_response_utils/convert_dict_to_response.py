...
class LLMResponseObjectHandler:
    ...
    def convert_chat_to_text_completion(
        ...
        """
        transformed_logprobs = LLMResponseObjectHandler._convert_provider_response_logprobs_to_text_completion_logprobs(
            response=response,
    ...
    def _convert_provider_response_logprobs_to_text_completion_logprobs(
        ...
        if custom_llm_provider == "huggingface":
            ...
            try:
                ...
                verbose_logger.exception(f"LLM non blocking exception: {e}")
...
def convert_to_model_response_object(  # noqa: PLR0915
    ...
    try:
        if response_type == "completion" and (
            ...
            return LLMResponseObjectHandler.convert_to_image_response(
