...
async def get_sso_settings():
    """
    Get all SSO settings from the llm_settings configuration.
    ...
    default_internal_user_params = (
        llm_settings.get("default_internal_user_params", {}) or {}
    )
...
async def update_internal_user_settings(settings: DefaultInternalUserParams):
    ...
    llm.default_internal_user_params = settings.model_dump(exclude_none=True)
    ...
    config["llm_settings"]["default_internal_user_params"] = settings.model_dump(
        exclude_none=True
    )
    ...
    return {
        ...
        "status": "success",
        "settings": llm.default_internal_user_params,
    }
