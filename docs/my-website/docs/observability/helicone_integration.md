...
## Using Helicone with Hanzo

Hanzo provides `success_callbacks` and `failure_callbacks`, allowing you to easily log data to Helicone based on the status of your responses.
...
There are two main approaches to integrate Helicone with Hanzo:
...
> By utilizing these headers and metadata options, you can gain deeper insights into your LLM usage, optimize performance, and better manage your AI workflows with Helicone and Hanzo.
