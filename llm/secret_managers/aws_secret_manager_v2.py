...
class AWSSecretsManagerV2(BaseAWSLLM, BaseSecretManager):
    ...
    def load_aws_secret_manager(cls, use_aws_secret_manager: Optional[bool]):
        """
        Initialize AWSSecretsManagerV2 and sets llm.secret_manager_client = AWSSecretsManagerV2() and llm._key_management_system = KeyManagementSystem.AWS_SECRET_MANAGER
        """
