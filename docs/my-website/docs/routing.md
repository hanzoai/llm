...
If you want a server to load balance across different LLM APIs, use our [LLM Proxy Server](./proxy/load_balancing.md)
...
Loadbalance across multiple [azure](./providers/azure.md)/[bedrock](./providers/bedrock.md)/[provider](./providers/) deployments. LLM will handle retrying in different regions if a call fails.
...
If you want a server to load balance across different LLM APIs, use our [LLM Proxy Server](./simple_proxy#load-balancing---multiple-instances-of-1-model)
