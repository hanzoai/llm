...
from llm.types.integrations.argilla import (
...
class ArgillaLogger(CustomBatchLogger):
    def __init__(
        ...
        **kwargs,
        ...
        if llm.argilla_transformation_object is None:
            raise Exception(
                "'llm.argilla_transformation_object' is required, to log your payload to Argilla."
            )
        self.validate_argilla_transformation_object(
            llm.argilla_transformation_object
        )
        self.argilla_transformation_object = llm.argilla_transformation_object
        ...
        _batch_size = (
            os.getenv("ARGILLA_BATCH_SIZE", None) or llm.argilla_batch_size
        )
        if _batch_size:
    ...
    def get_credentials_from_env(
        ...
        if _credentials_dataset_name is None:
            ...
            dataset_response = llm.module_level_client.get(
