...
import llm
from llm.llm_core_utils.llm_logging import Logging as HanzoLoggingObject
...
class BedrockConverseLLM(BaseAWSLLM):
    ...
    async def async_streaming(
        ...
        request_data = await llm.AmazonConverseConfig()._async_transform_request(
            model=model,
            messages=messages,
        ...
        prepped = self.get_request_headers(
            credentials=credentials,
            aws_region_name=llm_params.get("aws_region_name") or "us-west-2",
    ...
    async def async_completion(
        ...
        return llm.AmazonConverseConfig()._transform_response(
            model=model,
            response=response,
    ...
    def completion(  # noqa: PLR0915
        ...
        _data = llm.AmazonConverseConfig()._transform_request(
            model=model,
            messages=messages,
            optional_params=optional_params,
            llm_params=llm_params,
