...
Example trace in Langfuse using multiple models via Hanzo:
<Image img={require('../../img/langfuse-example-trace-multiple-models-min.png')} />


## Usage with Hanzo Proxy (LLM Gateway)

👉 [**Follow this link to start sending logs to langfuse with Hanzo Proxy server**](../proxy/logging)
...
<a target="_blank" href="https://colab.research.google.com/github/BerriAI/llm/blob/main/cookbook/logging_observability/Hanzo_Langfuse.ipynb">
