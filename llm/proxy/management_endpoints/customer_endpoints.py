...
@router.get(
    ...
    tags=["Customer Management"],
    dependencies=[Depends(user_api_key_auth)],
    response_model=LLM_EndUserTable,
)
@router.get(
    "/end_user/info",
    tags=["Customer Management"],
...
@router.get(
    ...
    tags=["Customer Management"],
    dependencies=[Depends(user_api_key_auth)],
    response_model=List[LLM_EndUserTable],
)
@router.get(
    "/end_user/list",
    tags=["Customer Management"],
...
async def list_end_user(
    ...
    returned_response: List[LLM_EndUserTable] = []
    for item in response:
        returned_response.append(LLM_EndUserTable(**item.model_dump()))
