    ...
    def add_llm_data_for_backend_llm_call(
        *,
        ...
        if (
            ...
            _headers = LLMProxyRequestSetup.add_headers_to_llm_call(
                headers, user_api_key_dict
            )
            if _headers != {}:
                data["headers"] = _headers
        _organization = LLMProxyRequestSetup.get_openai_org_id_from_headers(
    ...
    def add_key_level_controls(
        ...
        if "tags" in key_metadata and key_metadata["tags"] is not None:
            data[_metadata_variable_name]["tags"] = (
                LLMProxyRequestSetup._merge_tags(
...
async def add_llm_data_to_request(  # noqa: PLR0915
    ...
    """
    Adds LLM-specific data to the request.
    ...
    if "tags" in team_metadata and team_metadata["tags"] is not None:
        data[_metadata_variable_name]["tags"] = LLMProxyRequestSetup._merge_tags(
            request_tags=data[_metadata_variable_name].get("tags"),
    ...
    tags = LLMProxyRequestSetup.add_request_tag_to_metadata(
...
def _add_otel_traceparent_to_data(data: dict, request: Request):
    ...
    if open_telemetry_logger is None:
        ...
        # relevant issue: https://github.com/hanzoai/llm/issues/4448
        return
    ...
    if llm.forward_traceparent_to_llm_provider is True:
        if request.headers:
            if "traceparent" in request.headers:
                ...
                # Relevant issue: https://github.com/hanzoai/llm/issues/4419
