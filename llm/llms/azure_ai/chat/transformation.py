...
from llm.llms.base_llm.chat.transformation import HanzoLoggingObj
from llm.llms.openai.common_utils import drop_params_from_unprocessable_entity_error
from llm.llms.openai.openai import OpenAIConfig
from llm.secret_managers.main import get_secret_str
from llm.types.llms.openai import AllMessageValues
from llm.types.utils import ModelResponse, ProviderField
from llm.utils import _add_path_to_api_base, supports_tool_choice
...
class AzureAIStudioConfig(OpenAIConfig):
    ...
    def get_complete_url(
        ...
        api_version = cast(Optional[str], llm_params.get("api_version"))
    ...
    def transform_request(
        ...
        return super().transform_request(
            model, messages, optional_params, llm_params, headers
        )
    ...
    def should_retry_llm_api_inside_llm_translation_on_http_error(
        self, e: httpx.HTTPStatusError, llm_params: dict
    ) -> bool:
        should_drop_params = llm_params.get("drop_params") or llm.drop_params
    ...
    def transform_request_on_unprocessable_entity_error(
        ...
        if (
            ...
            llm.remove_index_from_tool_calls(
                messages=_messages,
            )
