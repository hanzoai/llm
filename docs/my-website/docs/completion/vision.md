...
<TabItem label="HanzoPython SDK" value="Python">
...
Hanzo will use this for any API endpoint, which supports specifying mime-type (e.g. anthropic/bedrock/vertex ai). 
