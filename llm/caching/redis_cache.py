...
from llm.types.caching import RedisPipelineIncrementOperation
...
class RedisCache(BaseCache):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if llm.default_redis_ttl is not None:
            super().__init__(default_ttl=int(llm.default_redis_ttl))
        else:
    ...
    def set_cache(self, key, value, **kwargs):
        ...
        try:
            ...
            print_verbose(
                f"llm.caching.caching: set() - Got exception from REDIS : {str(e)}"
            )
    ...
    def increment_cache(
        ...
        try:
            ...
            _duration = end_time - start_time
            verbose_logger.error(
                "Hanzo Redis Caching: increment_cache() - Got exception from REDIS %s, Writing value=%s",
                str(e),
                value,
            )
            raise e
    ...
    async def async_set_cache(self, key, value, **kwargs):
        ...
        try:
            ...
            verbose_logger.error(
                "Hanzo Redis Caching: async set() - Got exception from REDIS %s, Writing value=%s",
                str(e),
                value,
            )
            raise e
    ...
    async def async_set_cache_pipeline(
        ...
        try:
            ...
            verbose_logger.error(
                "Hanzo Redis Caching: async set_cache_pipeline() - Got exception from REDIS %s, Writing value=%s",
                str(e),
                cache_value,
            )
    ...
    async def async_set_cache_sadd(
        ...
        try:
            ...
            # NON blocking - notify users Redis is throwing an exception
            verbose_logger.error(
                "Hanzo Redis Caching: async set_cache_sadd() - Got exception from REDIS %s, Writing value=%s",
                str(e),
                value,
            )
    ...
    async def async_increment(
        ...
        try:
            ...
            verbose_logger.error(
                "Hanzo Redis Caching: async async_increment() - Got exception from REDIS %s, Writing value=%s",
                str(e),
                value,
            )
            raise e
    ...
    def get_cache(self, key, parent_otel_span: Optional[Span] = None, **kwargs):
        try:
            ...
            # NON blocking - notify users Redis is throwing an exception
            verbose_logger.error(
                "llm.caching.caching: get() - Got exception from REDIS: ", e
            )
    ...
    async def async_get_cache(
        ...
        try:
            ...
            print_verbose(
                f"llm.caching.caching: async get() - Got exception from REDIS: {str(e)}"
            )
    ...
    def sync_ping(self) -> bool:
        ...
        try:
            ...
            verbose_logger.error(
                f"Hanzo Redis Cache PING: - Got exception from REDIS : {str(e)}"
            )
            raise e
    ...
    async def async_increment_pipeline(
        ...
        try:
            ...
            verbose_logger.error(
                "Hanzo Redis Caching: async increment_pipeline() - Got exception from REDIS %s",
                str(e),
            )
            raise e
