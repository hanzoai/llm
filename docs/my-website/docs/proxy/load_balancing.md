...
The proxy will handle routing requests (using Hanzo's Router). **Set `rpm` in the config if you want maximize throughput**
...
2. Hanzo proxy will retry the request on the model group (default is 3).
