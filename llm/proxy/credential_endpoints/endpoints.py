...
from llm.llm_core_utils.llm_logging import _get_masked_values
from llm.proxy._types import CommonProxyErrors, UserAPIKeyAuth
...
from llm.proxy.utils import handle_exception_on_proxy, jsonify_object
from llm.types.utils import CreateCredentialItem, CredentialItem
...
async def create_credential(
    ...
    try:
        ...
        await prisma_client.db.llm_credentialstable.create(
            data={
...
async def delete_credential(
    ...
    try:
        ...
        await prisma_client.db.llm_credentialstable.delete(
...
async def update_credential(
    ...
    try:
        ...
        db_credential = await prisma_client.db.llm_credentialstable.find_unique(
            where={"credential_name": credential_name},
        )
        ...
        await prisma_client.db.llm_credentialstable.update(
            where={"credential_name": credential_name},
            data={
