...
def get_assistants(
    ...
    **kwargs,
    ...
    optional_params = GenericHanzoParams(
    ...
    if custom_llm_provider == "openai":
        ...
        api_base = (
            optional_params.api_base or llm.api_base or get_secret("AZURE_API_BASE")
        )  # type: ignore
        ...
        raise llm.exceptions.BadRequestError(
            message="Hanzo doesn't support {} for 'get_assistants'. Only 'openai' is supported.".format(
                custom_llm_provider
            ),
            model="n/a",
...
def create_assistants(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise llm.exceptions.BadRequestError(
            message="Hanzo doesn't support {} for 'create_assistants'. Only 'openai' is supported.".format(
                custom_llm_provider
            ),
            model="n/a",
            llm_provider=custom_llm_provider,
    ...
    if response is None:
        raise llm.exceptions.InternalServerError(
...
def delete_assistant(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise llm.exceptions.BadRequestError(
            message="Hanzo doesn't support {} for 'delete_assistant'. Only 'openai' is supported.".format(
                custom_llm_provider
            ),
            model="n/a",
            llm_provider=custom_llm_provider,
            response=httpx.Response(
                ...
                request=httpx.Request(
                    method="delete_assistant", url="https://github.com/BerriAI/llm"
                ),
            ),
        )
    if response is None:
...
def create_thread(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise llm.exceptions.BadRequestError(
            message="Hanzo doesn't support {} for 'create_thread'. Only 'openai' is supported.".format(
                custom_llm_provider
            ),
            model="n/a",
            llm_provider=custom_llm_provider,
...
def get_thread(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise llm.exceptions.BadRequestError(
            message="Hanzo doesn't support {} for 'get_thread'. Only 'openai' is supported.".format(
                custom_llm_provider
            ),
            model="n/a",
            llm_provider=custom_llm_provider,
...
def get_messages(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise llm.exceptions.BadRequestError(
            message="Hanzo doesn't support {} for 'get_messages'. Only 'openai' is supported.".format(
                custom_llm_provider
            ),
            model="n/a",
            llm_provider=custom_llm_provider,
...
def run_thread(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise llm.exceptions.BadRequestError(
            message="Hanzo doesn't support {} for 'run_thread'. Only 'openai' is supported.".format(
                custom_llm_provider
            ),
            model="n/a",
            llm_provider=custom_llm_provider,
