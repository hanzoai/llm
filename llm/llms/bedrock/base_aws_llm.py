...
from llm.constants import BEDROCK_INVOKE_PROVIDERS_LITERAL
...
class BaseAWSLLM:
    ...
    def _get_aws_region_name(
        ...
        if aws_region_name is None:
            ...
            if (
                ...
                and llm_aws_region_name is not None
                and isinstance(llm_aws_region_name, str)
            ):
    ...
    def _auth_with_web_identity_token(
        ...
        sts_response = sts_client.assume_role_with_web_identity(
            ...
            Policy='{"Version":"2012-10-17","Statement":[{"Sid":"BedrockHanzo","Effect":"Allow","Action":["bedrock:InvokeModel","bedrock:InvokeModelWithResponseStream"],"Resource":"*","Condition":{"Bool":{"aws:SecureTransport":"true"},"StringLike":{"aws:UserAgent":"llm/*"}}}]}',
        )
