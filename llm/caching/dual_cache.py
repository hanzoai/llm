...
class DualCache(BaseCache):
    ...
    def __init__(
        ...
        self.redis_batch_cache_expiry = (
            ...
            or llm.default_redis_batch_cache_expiry
            or 10
        )
        self.default_in_memory_ttl = (
            default_in_memory_ttl or llm.default_in_memory_ttl
        )
        self.default_redis_ttl = default_redis_ttl or llm.default_redis_ttl
    ...
    def increment_cache(
        ...
        try:
            ...
            verbose_logger.error(f"Hanzo Cache: Excepton async add_cache: {str(e)}")
            raise e
    ...
    async def async_set_cache(self, key, value, local_only: bool = False, **kwargs):
        ...
        try:
            ...
            verbose_logger.exception(
                f"Hanzo Cache: Excepton async add_cache: {str(e)}"
            )
