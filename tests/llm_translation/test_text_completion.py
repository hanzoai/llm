...
def test_convert_chat_to_text_completion():
    ...
    result = HanzoResponseObjectHandler.convert_chat_to_text_completion(
...
def test_convert_provider_response_logprobs():
    ...
    result = HanzoResponseObjectHandler._convert_provider_response_logprobs_to_text_completion_logprobs(
