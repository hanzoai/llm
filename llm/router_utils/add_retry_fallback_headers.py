...
from llm.types.utils import HiddenParams
...
def add_retry_headers_to_response(
    ...
    """
    retry_headers = {
        "x-llm-attempted-retries": attempted_retries,
    }
    if max_retries is not None:
        retry_headers["x-llm-max-retries"] = max_retries
...
def add_fallback_headers_to_response(
    ...
    """
    fallback_headers = {
        "x-llm-attempted-fallbacks": attempted_fallbacks,
    }
