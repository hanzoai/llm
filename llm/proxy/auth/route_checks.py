...
class RouteChecks:
    ...
    def non_proxy_admin_allowed_routes_check(
        ...
        if RouteChecks.is_llm_api_route(route=route):
            ...
            route in LLMRoutes.info_routes.value
            ...
            route in LLMRoutes.global_spend_tracking_routes.value
            ...
            if RouteChecks.check_route_access(
                route=route, allowed_routes=LLMRoutes.management_routes.value
            ):
            ...
            and RouteChecks.check_route_access(
                route=route, allowed_routes=LLMRoutes.internal_user_routes.value
            )
        ):
            pass
            ...
            route=route, allowed_routes=LLMRoutes.org_admin_allowed_routes.value
        ):
            pass
        elif (
            ...
            and RouteChecks.check_route_access(
                route=route,
                allowed_routes=LLMRoutes.internal_user_view_only_routes.value,
            )
        ):
            pass
        elif RouteChecks.check_route_access(
            route=route, allowed_routes=LLMRoutes.self_managed_routes.value
    ...
    def is_llm_api_route(route: str) -> bool:
        ...
        if route in LLMRoutes.openai_routes.value:
            return True

        if route in LLMRoutes.anthropic_routes.value:
            return True

        # fuzzy match routes like "/v1/threads/thread_49EIN5QF32s4mH20M7GFKdlZ"
        # Check for routes with placeholders
        for openai_route in LLMRoutes.openai_routes.value:
        ...
        for _llm_passthrough_route in LLMRoutes.mapped_pass_through_routes.value:
