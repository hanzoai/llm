...
This is what Hanzo will log to Lagos
...
```
{
    "event": {
      ...
      "properties": {
          ...
          "model": <string>,
          "response_cost": <number>, # 👈 LLM CALCULATED RESPONSE COST - https://github.com/BerriAI/llm/blob/d43f75150a65f91f60dc2c0c9462ce3ffc713c1f/llm/utils.py#L1473
      }
    }
}
```