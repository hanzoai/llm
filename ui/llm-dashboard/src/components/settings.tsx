...
const Settings: React.FC<SettingsPageProps> = ({
  ...
  return (
    <div className="w-full mx-4">
      ...
      <Text>
      <a href="https://docs.llm.ai/docs/proxy/email" target="_blank" style={{ color: "blue" }}> Hanzo Docs: email alerts</a> <br/>        
      </Text>
<div className="flex w-full">
  {alerts
    ...
    .map((alert, index) => (
      ...
      <a href="https://docs.llm.ai/docs/proxy/logging" className="mb-8 mt-4" target="_blank" style={{ color: "blue" }}> Hanzo Docs: Logging</a>
