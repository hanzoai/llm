...
from llm.integrations.custom_logger import Span
...
class _PROXY_VirtualKeyModelMaxBudgetLimiter(RouterBudgetLimiting):
        ...
        if (
            ...
            if (
                ...
                raise llm.BudgetExceededError(
                    message=f"Hanzo Virtual Key: {user_api_key_dict.token}, key_alias: {user_api_key_dict.key_alias}, exceeded budget for model={model}",
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        _llm_params: dict = kwargs.get("llm_params", {}) or {}
        _metadata: dict = _llm_params.get("metadata", {}) or {}
