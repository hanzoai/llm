...
def get_file_contents_from_s3(bucket_name, object_key):
    try:
        ...
        from llm.main import bedrock_converse_chat_completion
        ...
        # this is most likely if a user is not using the llm docker container
...
# # Example usage
# bucket_name = 'llm-proxy'
# object_key = 'llm_proxy_config.yaml'
