...
def completion(
    ...
    if "stream" in optional_params and optional_params["stream"] is True:
        ...
        for retry in range(llm.DEFAULT_REPLICATE_POLLING_RETRIES):
            time.sleep(
                llm.DEFAULT_REPLICATE_POLLING_DELAY_SECONDS + 2 * retry
            ...
            if (
                ...
                continue
            return llm.ReplicateConfig().transform_response(
                model=model,
