...
async def create_missing_views(db: _db):  # noqa: PLR0915
    ...
    try:
        ...
        await db.query_raw("""SELECT 1 FROM "Hanzo_VerificationTokenView" LIMIT 1""")
        print("Hanzo_VerificationTokenView Exists!")  # noqa
    except Exception:
        ...
        print("Hanzo_VerificationTokenView Created!")  # noqa
...
async def should_create_missing_views(db: _db) -> bool:
    ...
    verbose_logger.debug("Estimated Row count of Hanzo_SpendLogs = {}".format(result))
    if (
        result
