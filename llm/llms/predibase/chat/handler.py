...
from llm.types.utils import LLMLoggingBaseClass
from llm.utils import Choices, CustomStreamWrapper, Message, ModelResponse, Usage
...
class PredibaseChatCompletion:
    ...
    def output_parser(self, generated_text: str):
        ...
        Initial issue that prompted this - https://github.com/hanzoai/llm/issues/763
        """
    ...
    def process_response(  # noqa: PLR0915
        ...
        stream: bool,
        logging_obj: LLMLoggingBaseClass,
        ...
        prompt_tokens = 0
        try:
            prompt_tokens = llm.token_counter(messages=messages)
        except Exception:
    ...
    def completion(
        ...
        headers = llm.PredibaseConfig().validate_environment(
            api_key=api_key,
            headers=headers,
            messages=messages,
        ...
        ## Load Config
        config = llm.PredibaseConfig.get_config()
    ...
    async def async_completion(
        ...
        async_handler = get_async_httpx_client(
            llm_provider=llm.LLMProviders.PREDIBASE,
        ...
        try:
            ...
            for exception in llm.LLM_EXCEPTION_TYPES:
