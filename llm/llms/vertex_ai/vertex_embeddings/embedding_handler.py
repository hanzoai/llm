...
from llm.llms.vertex_ai.vertex_ai_non_gemini import VertexAIError
from llm.llms.vertex_ai.vertex_llm_base import VertexBase
from llm.types.llms.vertex_ai import *
from llm.types.utils import EmbeddingResponse
...
class VertexEmbedding(VertexBase):
    ...
    def embedding(
        ...
        vertex_request: VertexEmbeddingRequest = (
            llm.vertexAITextEmbeddingConfig.transform_openai_request_to_vertex_embedding_request(
        ...
        model_response = (
            llm.vertexAITextEmbeddingConfig.transform_vertex_response_to_openai(
