...
from llm.proxy._types import SpecialModelNames, UserAPIKeyAuth
...
def get_provider_models(provider: str) -> Optional[List[str]]:
    ...
    if provider in llm.models_by_provider:
        provider_models = copy.deepcopy(llm.models_by_provider[provider])
