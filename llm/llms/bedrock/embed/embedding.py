...
import llm
from llm.llms.cohere.embed.handler import embedding as cohere_embedding
...
from llm.types.llms.bedrock import AmazonEmbeddingRequest, CohereEmbeddingRequest
