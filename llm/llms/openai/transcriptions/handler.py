...
import llm
from llm.llm_core_utils.audio_utils.utils import get_audio_file_name
from llm.llm_core_utils.llm_logging import Logging as HanzoLoggingObj
from llm.types.utils import FileTypes
...
class OpenAIAudioTranscription(OpenAIChatCompletion):
    ...
    async def make_openai_audio_transcriptions_request(
        ...
        """
        Helper to:
        - call openai_aclient.audio.transcriptions.with_raw_response when llm.return_response_headers is True
    ...
    def make_sync_openai_audio_transcriptions_request(
        ...
        """
        try:
            if llm.return_response_headers is True:
                raw_response = (
