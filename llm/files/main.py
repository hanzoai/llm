...
async def afile_retrieve(
    ...
    **kwargs,
    ...
    Hanzo Equivalent of GET https://api.openai.com/v1/files
    """
    try:
...
def file_retrieve(
    ...
    **kwargs,
    ...
    Hanzo Equivalent of POST: POST https://api.openai.com/v1/files
    """
    try:
        ...
        if custom_llm_provider == "openai":
            ...
            raise llm.exceptions.BadRequestError(
                message="Hanzo doesn't support {} for 'file_retrieve'. Only 'openai' and 'azure' are supported.".format(
                    custom_llm_provider
                ),
                model="n/a",
...
async def afile_delete(
    ...
    **kwargs,
    ...
    Hanzo Equivalent of DELETE https://api.openai.com/v1/files
    """
    try:
        loop = asyncio.get_event_loop()
        kwargs["is_async"] = True
    ...
    **kwargs,
    ...
    try:
        ...
        if custom_llm_provider == "openai":
            ...
            raise llm.exceptions.BadRequestError(
                message="Hanzo doesn't support {} for 'file_list'. Only 'openai' and 'azure' are supported.".format(
                    custom_llm_provider
                ),
                model="n/a",
                llm_provider=custom_llm_provider,
    ...
    **kwargs,
    ...
    try:
        ...
        if custom_llm_provider == "openai":
            ...
            raise llm.exceptions.BadRequestError(
                message="Hanzo doesn't support {} for 'custom_llm_provider'. Supported providers are 'openai', 'azure', 'vertex_ai'.".format(
                    custom_llm_provider
                ),
                model="n/a",
                llm_provider=custom_llm_provider,
