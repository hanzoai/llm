...
from llm.types.rerank import OptionalRerankParams, RerankRequest
...
class CohereRerankConfig(BaseRerankConfig):
    ...
    def validate_environment(
        ...
        if api_key is None:
            raise ValueError(
                "Cohere API key is required. Please set 'COHERE_API_KEY' or 'CO_API_KEY' or 'llm.cohere_key'"
            )
    ...
    def transform_rerank_response(
        ...
        No transformation required, llm follows cohere API response format
        """
        try:
