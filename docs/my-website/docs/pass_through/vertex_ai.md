...
Hanzo Proxy Server supports two methods of authentication to Vertex AI:
...
Use this if you wants `tags` to be tracked in the Hanzo DB and on logging callbacks
