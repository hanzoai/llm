...
class RedisSemanticCache(BaseCache):
    def __init__(
        ...
        **kwargs,
        ...
        print_verbose(
            "redis semantic-cache initializing INDEX - llm_semantic_cache_index"
        )
        ...
        if use_async is False:
            ...
            schema["index"]["name"] = "llm_semantic_cache_index_async"
            self.index = SearchIndex.from_dict(schema)
    ...
    def set_cache(self, key, value, **kwargs):
        ...
        new_data = [
            {"response": value, "prompt": prompt, "llm_embedding": embedding_bytes}
        ]
    ...
    def get_cache(self, key, **kwargs):
        ...
        query = VectorQuery(
            vector=embedding,
            vector_field_name="llm_embedding",
    ...
    async def async_set_cache(self, key, value, **kwargs):
        ...
        from llm.proxy.proxy_server import llm_model_list, llm_router
