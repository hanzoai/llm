...
Create a new Internal User on Hanzo and assign them the role `internal_user`.
...
Here's the available UI roles for a Hanzo Internal User: 
...
Hanzo Enterprise: Enable [SSO login](./ui.md#setup-ssoauth-for-ui)
