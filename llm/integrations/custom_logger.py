...
from llm.types.integrations.argilla import ArgillaItem
from llm.types.llms.openai import AllMessageValues, ChatCompletionRequest
...
class CustomLogger:  # https://docs.hanzo.ai/docs/observability/custom_callback#callback-class
    ...
    def translate_completion_input_params(
        ...
        """
        Translates the input params, from the provider's native format to the llm.completion() format.
        """
        pass
