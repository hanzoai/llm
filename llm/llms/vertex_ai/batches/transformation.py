...
from llm.types.llms.openai import BatchJobStatus, CreateBatchRequest
...
class VertexAIBatchTransformation:
    ...
    def _get_model_from_gcs_file(cls, gcs_file_uri: str) -> str:
        ...
        When files are uploaded using Hanzo (/v1/files), the model is stored in the gcs file uri
