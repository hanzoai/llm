...
2. **Do NOT** add anything additional to the base url e.g. `/v1/embedding`. LLM uses the openai-client to make these calls, and that automatically adds the relevant endpoints. 
