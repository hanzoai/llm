...
from llm.llm_core_utils.llm_logging import StandardLoggingPayloadSetup
...
class _ProxyDBLogger(CustomLogger):
    ...
    async def async_post_call_failure_hook(
        ...
        from llm.proxy.proxy_server import update_database
        ...
        if "llm_params" not in request_data:
            request_data["llm_params"] = {}
        request_data["llm_params"]["proxy_server_request"] = (
            request_data.get("proxy_server_request") or {}
        )
        request_data["llm_params"]["metadata"] = existing_metadata
    ...
    async def _PROXY_track_cost_callback(
        ...
        try:
            ...
            metadata = get_llm_metadata_from_kwargs(kwargs=kwargs)
            ...
            model = kwargs.get("model", "")
            metadata = kwargs.get("llm_params", {}).get("metadata", {})
