...
### Step 1: Start Hanzo Proxy on the CLI
Hanzo allows you to create an OpenAI compatible server for all supported LLMs. [More information on llm proxy here](https://docs.llm.ai/docs/simple_proxy)
