...
from llm.types.utils import LLMBatch
...
async def acreate_batch(
    ...
    **kwargs,
    ...
    LLM Equivalent of POST: https://api.openai.com/v1/batches
    """
    try:
...
def create_batch(
    ...
    **kwargs,
    ...
    try:
        ...
        llm_logging_obj: LLMLoggingObj = kwargs.get("llm_logging_obj", None)
        ### TIMEOUT LOGIC ###
        ...
        if custom_llm_provider == "openai":
            ...
            raise llm.exceptions.BadRequestError(
                message="LLM doesn't support custom_llm_provider={} for 'create_batch'".format(
                    custom_llm_provider
                ),
                model="n/a",
                ...
                response=httpx.Response(
                    ...
                    request=httpx.Request(method="create_batch", url="https://github.com/hanzoai/llm"),  # type: ignore
                ),
            )
        return response
    except Exception as e:
...
async def aretrieve_batch(
    ...
    **kwargs,
    ...
    LLM Equivalent of GET https://api.openai.com/v1/batches/{batch_id}
    """
    try:
        loop = asyncio.get_event_loop()
    ...
    **kwargs,
    ...
    try:
        ...
        if custom_llm_provider == "openai":
            ...
            raise llm.exceptions.BadRequestError(
                message="LLM doesn't support {} for 'list_batch'. Only 'openai' is supported.".format(
                    custom_llm_provider
                ),
                model="n/a",
                llm_provider=custom_llm_provider,
...
async def acancel_batch(
    ...
    **kwargs,
    ...
    LLM Equivalent of POST https://api.openai.com/v1/batches/{batch_id}/cancel
    """
    try:
        loop = asyncio.get_event_loop()
    ...
    **kwargs,
    ...
    try:
        ...
        if custom_llm_provider == "openai":
            ...
            raise llm.exceptions.BadRequestError(
                message="LLM doesn't support {} for 'cancel_batch'. Only 'openai' and 'azure' are supported.".format(
                    custom_llm_provider
                ),
                model="n/a",
                llm_provider=custom_llm_provider,
                response=httpx.Response(
                    status_code=400,
                    content="Unsupported provider",
                    request=httpx.Request(method="cancel_batch", url="https://github.com/hanzoai/llm"),  # type: ignore
                ),
            )
        return response
    except Exception as e:
