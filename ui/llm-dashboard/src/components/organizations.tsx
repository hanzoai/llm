...
const OrganizationsTable: React.FC<OrganizationsTableProps> = ({
  ...
  if (!premiumUser) {
    return (
      <div>
        <Text>This is a Hanzo Enterprise feature, and requires a valid key to use. Get a trial key <a href="https://llm.ai/pricing" target="_blank" rel="noopener noreferrer">here</a>.</Text>
      </div>
    );
  }
