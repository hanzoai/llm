...
class JWTAuthManager:
    ...
    async def find_and_validate_specific_team_id(
    ...
    ) -> Tuple[Optional[str], Optional[Hanzo_TeamTable]]:
        ...
        team_object: Optional[Hanzo_TeamTable] = None
    ...
    async def get_objects(
        ...
        org_object: Optional[Hanzo_OrganizationTable] = None
        if org_id:
            org_object = (
        ...
        end_user_object: Optional[Hanzo_EndUserTable] = None
        if end_user_id:
            end_user_object = (
