...
class GenericHanzoParams(BaseModel):
    """
    Hanzo Params without 'model' arg (used across completion / assistants api)
    """
...
class Hanzo_Params(GenericHanzoParams):
    """
...
class updateHanzoParams(GenericHanzoParams):
    # This class is used to update the Hanzo_Params
...
class updateDeployment(BaseModel):
    ...
    llm_params: Optional[updateHanzoParams] = None
    model_info: Optional[ModelInfo] = None

    model_config = ConfigDict(protected_namespaces=())


class HanzoParamsTypedDict(TypedDict, total=False):
    model: str
...
class DeploymentTypedDict(TypedDict, total=False):
    ...
    llm_params: Required[HanzoParamsTypedDict]
    model_info: dict
