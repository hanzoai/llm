...
class MyCustomHandler(CustomLogger):
    def __init__(self):
        ...
        print_verbose(f"{blue_color_code}Initialized Hanzo custom logger")
        try:
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        response_cost = llm.completion_cost(completion_response=response_obj)
...
# need to set llm.callbacks = [customHandler] # on the proxy

# llm.success_callback = [async_on_succes_logger]
