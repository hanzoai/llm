...
from llm.proxy.llm_pre_call_utils import _get_dynamic_logging_metadata
...
async def langfuse_proxy_route(
    ...
    """
    Call Langfuse via Hanzo proxy. Works with Langfuse SDK.
    ...
    langfuse_public_key = dynamic_langfuse_public_key or llm.utils.get_secret(
        secret_name="LANGFUSE_PUBLIC_KEY"
    )
    langfuse_secret_key = dynamic_langfuse_secret_key or llm.utils.get_secret(
