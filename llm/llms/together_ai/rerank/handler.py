...
Hanzo supports the re rank API format, no paramter transformation occurs
"""
...
from llm.llms.together_ai.rerank.transformation import TogetherAIRerankConfig
from llm.types.rerank import RerankRequest, RerankResponse
...
class TogetherAIRerank(BaseLLM):
    ...
    async def async_rerank(  # New async method
        ...
        client = get_async_httpx_client(
            llm_provider=llm.LlmProviders.TOGETHER_AI
        )  # Use async client
