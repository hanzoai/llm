  ...
  if (proxySettings) {
    ...
    return (
        ...
        <div className="mb-5">
            ...
            <Text className="mt-2 mb-2">Hanzo is OpenAI Compatible. This means your API Key works with the OpenAI SDK. Just replace the base_url to point to your llm proxy. Example Below </Text>
...
client = openai.OpenAI(
    ...
    base_url="${base_url}" # Hanzo Proxy is OpenAI compatible, Read More: https://docs.llm.ai/docs/proxy/user_keys
)
...
llm = AzureOpenAI(
    ...
    temperature=0.0,
    azure_endpoint="${base_url}", # llm proxy endpoint
