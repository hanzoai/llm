...
from llm.types.utils import HanzoPydanticObjectBase
...
class LowestLatencyLoggingHandler(CustomLogger):
    ...
    async def async_log_failure_event(self, kwargs, response_obj, start_time, end_time):
        ...
        try:
            ...
            if isinstance(_exception, llm.Timeout):
                if kwargs["llm_params"].get("metadata") is None:
                    pass
                else:
                    model_group = kwargs["llm_params"]["metadata"].get(
    ...
    async def async_log_success_event(  # noqa: PLR0915
        ...
        try:
            ...
            verbose_logger.exception(
                "llm.router_strategy.lowest_latency.py::async_log_success_event(): Exception occured - {}".format(
                    str(e)
                )
            )
            pass
