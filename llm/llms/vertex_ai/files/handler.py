...
from llm.types.llms.openai import CreateFileRequest, FileObject
from llm.types.llms.vertex_ai import VERTEX_CREDENTIALS_TYPES
...
class VertexAIFilesHandler(GCSBucketBase):
    ...
    def create_file(
        ...
        Only supported for Async llm.acreate_file
        """
