...
from llm.llm_core_utils.redact_messages import HanzoLoggingObject
...
class CustomStreamWrapper:
    def __init__(
        ...
        self.logging_obj: HanzoLoggingObject = logging_obj
        self.completion_stream = completion_stream
        self.sent_first_chunk = False
        self.sent_last_chunk = False

        llm_params: GenericHanzoParams = GenericHanzoParams(
    ...
    async def __anext__(self):  # noqa: PLR0915
        ...
        try:
            ...
            traceback_exception += "\nHanzo Default Request Timeout - {}".format(
                llm.request_timeout
            )
