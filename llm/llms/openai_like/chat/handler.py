...
from llm.types.utils import CustomStreamingDecoder, ModelResponse
from llm.utils import CustomStreamWrapper, ProviderConfigManager
...
def make_sync_call(
    ...
    if client is None:
        client = llm.module_level_client  # Create a new client if none provided
