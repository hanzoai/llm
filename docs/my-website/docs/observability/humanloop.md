...
Use Humanloop to manage prompts across all LLM Providers.
...
LLM will call humanloop's `https://api.humanloop.com/v5/prompts/<your-prompt-id>` endpoint, to get the prompt template.
