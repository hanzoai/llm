...
log_level = os.getenv("LLM_LOG", "DEBUG")
...
verbose_proxy_logger = logging.getLogger("Hanzo Proxy")
verbose_router_logger = logging.getLogger("Hanzo Router")
verbose_logger = logging.getLogger("Hanzo")
