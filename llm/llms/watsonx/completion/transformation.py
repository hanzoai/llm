...
from llm.types.llms.openai import AllMessageValues, ChatCompletionUsageBlock
from llm.types.llms.watsonx import WatsonXAIEndpoint
from llm.types.utils import GenericStreamingChunk, ModelResponse, Usage
from llm.utils import map_finish_reason
...
class IBMWatsonXAIConfig(IBMWatsonXMixin, BaseConfig):
    ...
    max_new_tokens: Optional[int] = None  # llm.max_tokens
