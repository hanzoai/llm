...
def _ensure_extra_body_is_safe(extra_body: Optional[Dict]) -> Optional[Dict]:
    ...
    Relevant Issue: https://github.com/BerriAI/llm/issues/4140
    """
...
def pick_cheapest_chat_models_from_llm_provider(custom_llm_provider: str, n=1):
    ...
    """
    if custom_llm_provider not in llm.models_by_provider:
        return []

    known_models = llm.models_by_provider.get(custom_llm_provider, [])
    model_costs = []
