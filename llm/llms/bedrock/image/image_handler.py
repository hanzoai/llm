...
from llm.llm_core_utils.llm_logging import Logging as LitellmLogging
...
class BedrockImageGeneration(BaseAWSLLM):
    ...
    def _get_request_body(
        ...
        if provider == "stability":
            if llm.AmazonStability3Config._is_stability_3_model(model):
                request_body = llm.AmazonStability3Config.transform_request_body(
                ...
                ## LOAD CONFIG
                config = llm.AmazonStabilityConfig.get_config()
            ...
            return dict(llm.AmazonNovaCanvasConfig.transform_request_body(text=prompt, optional_params=optional_params))
        else:
            raise BedrockError(
