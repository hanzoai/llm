...
This is currently only supported on `/chat/completions` and `/completions` endpoints. Please [let us know](https://github.com/hanzoai/llm/issues) if you need this for other endpoints. 
