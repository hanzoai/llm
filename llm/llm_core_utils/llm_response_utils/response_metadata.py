...
from llm.llm_core_utils.logging_utils import LLMLoggingObject
...
class ResponseMetadata:
    """
    Handles setting and managing `_hidden_params`, `response_time_ms`, and `llm_overhead_time_ms` for LLM responses
    """
    ...
    def set_hidden_params(
        self, logging_obj: LLMLoggingObject, model: Optional[str], kwargs: dict
    ) -> None:
