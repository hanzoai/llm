...
from llm.router_utils.cooldown_handlers import _async_get_cooldown_deployments
from llm.types.integrations.slack_alerting import AlertType
from llm.types.router import RouterRateLimitError
...
async def send_llm_exception_alert(
    ...
    if "proxy_server_request" in request_kwargs:
        # Do not send any alert if it's a request from llm proxy server request
