...
from llm.llms.bedrock.rerank.handler import BedrockRerankHandler
from llm.llms.custom_httpx.llm_http_handler import BaseLLMHTTPHandler
from llm.llms.together_ai.rerank.handler import TogetherAIRerank
from llm.rerank_api.rerank_utils import get_optional_rerank_params
from llm.secret_managers.main import get_secret, get_secret_str
from llm.types.rerank import OptionalRerankParams, RerankResponse
from llm.types.router import *
from llm.utils import ProviderConfigManager, client, exception_type
...
def rerank(  # noqa: PLR0915
    ...
    custom_llm_provider: Optional[
        Literal["cohere", "together_ai", "azure_ai", "infinity", "llm_proxy"]
    ] = None,
    top_n: Optional[int] = None,
    rank_fields: Optional[List[str]] = None,
    ...
    **kwargs,
    ...
    try:
        ...
        optional_rerank_params: OptionalRerankParams = get_optional_rerank_params(
            ...
            model=model,
            drop_params=kwargs.get("drop_params") or llm.drop_params or False,
            query=query,
            documents=documents,
        ...
        if _custom_llm_provider == "cohere" or _custom_llm_provider == "llm_proxy":
            # Implement Cohere rerank logic
            api_key: Optional[str] = (
                dynamic_api_key or optional_params.api_key or llm.api_key
            )
            ...
            api_key = dynamic_api_key or optional_params.api_key or llm.api_key
