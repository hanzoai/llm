...
from llm import supports_response_schema, supports_system_messages, verbose_logger
from llm.llms.base_llm.chat.transformation import BaseLLMException
from llm.types.llms.vertex_ai import PartType
...
def get_supports_system_message(
    ...
    try:
        ...
        verbose_logger.warning(
            "Unable to identify if system message supported. Defaulting to 'False'. Received error message - {}\nAdd it here - https://github.com/hanzoai/llm/blob/main/model_prices_and_context_window.json".format(
                str(e)
            )
        )
...
def _check_text_in_content(parts: List[PartType]) -> bool:
    ...
    check that user_content has 'text' parameter.
        ...
        - Relevant Issue: https://github.com/hanzoai/llm/issues/5515
    """
...
def construct_target_url(
    ...
    Handle cachedContent scenario - https://github.com/hanzoai/llm/issues/5460
