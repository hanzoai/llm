"""
llm.Router Types - includes RouterConfig, UpdateRouterConfig, ModelInfo etc
"""
...
class ModelConfig(BaseModel):
    model_name: str
    llm_params: Union[CompletionRequest, EmbeddingRequest]
    tpm: int
    rpm: int
...
class RouterConfig(BaseModel):
    ...
    default_llm_params: Optional[Dict[str, str]] = {}
...
class CredentialLLMParams(BaseModel):
...
class GenericLLMParams(CredentialLLMParams):
    """
    LLM Params without 'model' arg (used across completion / assistants api)
    """
    ...
    def __init__(
        ...
        **params,
        ...
        # We need to keep max_retries in args since it's a parameter of GenericLLMParams
        args["max_retries"] = (
...
class LLM_Params(GenericLLMParams):
    """
    ...
    def __init__(
        ...
        # set a max-size of file that can be passed to llm proxy
        max_file_size_mb: Optional[float] = None,
...
class updateLLMParams(GenericLLMParams):
    # This class is used to update the LLM_Params
...
class updateDeployment(BaseModel):
    ...
    llm_params: Optional[updateLLMParams] = None
    model_info: Optional[ModelInfo] = None

    model_config = ConfigDict(protected_namespaces=())


class LLMParamsTypedDict(TypedDict, total=False):
    model: str
...
class DeploymentTypedDict(TypedDict, total=False):
    ...
    llm_params: Required[LLMParamsTypedDict]
    model_info: dict
    ...
    def __init__(
        ...
        **params,
        ...
        for (
            ...
            field = getattr(llm_params, key, None)
...
class AllowedFailsPolicy(BaseModel):
    ...
    https://docs.hanzo.ai/docs/exception_mapping
    """
