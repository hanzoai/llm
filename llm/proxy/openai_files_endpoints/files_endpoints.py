...
import llm
from llm import CreateFileRequest, get_secret_str
...
async def create_file(
    ...
    try:
        ...
        if llm.enable_loadbalancing_on_batch_endpoints is True:
        ...
        if (
            llm.enable_loadbalancing_on_batch_endpoints is True
            and is_router_model
            ...
            response = await llm.acreate_file(**_create_file_request, custom_llm_provider=custom_llm_provider)  # type: ignore
        ...
        verbose_proxy_logger.error(
            "llm.proxy.proxy_server.create_file(): Exception occured - {}".format(
                str(e)
            )
        )
...
async def get_file_content(
    ...
    try:
        ...
        response = await llm.afile_content(
        ...
        verbose_proxy_logger.error(
            "llm.proxy.proxy_server.retrieve_file_content(): Exception occured - {}".format(
                str(e)
            )
        )
        verbose_proxy_logger.debug(traceback.format_exc())
...
async def get_file(
    ...
    try:
        ...
        response = await llm.afile_retrieve(
            custom_llm_provider=custom_llm_provider, file_id=file_id, **data  # type: ignore
        )
        ...
        verbose_proxy_logger.error(
            "llm.proxy.proxy_server.retrieve_file(): Exception occured - {}".format(
                str(e)
            )
        )
        verbose_proxy_logger.debug(traceback.format_exc())
...
async def delete_file(
    ...
    try:
        ...
        response = await llm.afile_delete(
            custom_llm_provider=custom_llm_provider, file_id=file_id, **data  # type: ignore
        )
...
async def list_files(
    ...
    try:
        ...
        verbose_proxy_logger.error(
            "llm.proxy.proxy_server.list_files(): Exception occured - {}".format(
                str(e)
            )
        )
        verbose_proxy_logger.debug(traceback.format_exc())
