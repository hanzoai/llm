...
Relevant issue: https://github.com/BerriAI/llm/issues/1235
...
def load_google_kms(use_google_kms: Optional[bool]):
    ...
    try:
        ...
        llm._key_management_system = KeyManagementSystem.GOOGLE_KMS
        llm._google_kms_resource_name = os.getenv("GOOGLE_KMS_RESOURCE_NAME")
