...
# Aporia Guardrails with Hanzo Gateway

In this tutorial we will use Hanzo AI Gateway with Aporia to detect PII in requests and profanity in responses
...
## 2. Define Guardrails on your Hanzo config.yaml 
