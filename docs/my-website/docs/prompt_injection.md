...
Hanzo Supports the following methods for detecting prompt injection attacks
...
Hanzo supports similarity checking against a pre-generated list of prompt injection attacks, to identify if a request contains an attack. 
