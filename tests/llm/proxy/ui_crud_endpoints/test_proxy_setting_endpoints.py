...
class TestProxySettingEndpoints:
    ...
    def test_get_internal_user_settings(self, mock_proxy_config, mock_auth):
        ...
        values = data["values"]
        mock_params = mock_proxy_config["config"]["llm_settings"][
            "default_internal_user_params"
        ]
    ...
    def test_update_internal_user_settings(
        ...
        monkeypatch.setattr(llm, "default_internal_user_params", {})
        ...
        updated_config = mock_proxy_config["config"]["llm_settings"][
            "default_internal_user_params"
        ]
