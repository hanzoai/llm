...
class VertexAIPartnerModels(VertexBase):
    ...
    def completion(
        ...
        try:
            ...
            from llm.llms.anthropic.chat import AnthropicChatCompletion
            from llm.llms.codestral.completion.handler import (
                CodestralTextCompletion,
            )
            from llm.llms.openai_like.chat.handler import OpenAILikeChatHandler
        ...
        try:
            ...
            if "codestral" in model and llm_params.get("text_completion") is True:
