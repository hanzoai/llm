...
def get_assistants(
    ...
    **kwargs,
    ...
    optional_params = GenericLLMParams(
    ...
    if custom_llm_provider == "openai":
        ...
        raise llm.exceptions.BadRequestError(
            message="LLM doesn't support {} for 'get_assistants'. Only 'openai' is supported.".format(
                custom_llm_provider
            ),
            model="n/a",
...
def create_assistants(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise llm.exceptions.BadRequestError(
            message="LLM doesn't support {} for 'create_assistants'. Only 'openai' is supported.".format(
                custom_llm_provider
            ),
            model="n/a",
            llm_provider=custom_llm_provider,
...
def delete_assistant(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise llm.exceptions.BadRequestError(
            message="LLM doesn't support {} for 'delete_assistant'. Only 'openai' is supported.".format(
                custom_llm_provider
            ),
            model="n/a",
            llm_provider=custom_llm_provider,
...
def create_thread(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise llm.exceptions.BadRequestError(
            message="LLM doesn't support {} for 'create_thread'. Only 'openai' is supported.".format(
                custom_llm_provider
            ),
            model="n/a",
            llm_provider=custom_llm_provider,
...
def get_thread(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise llm.exceptions.BadRequestError(
            message="LLM doesn't support {} for 'get_thread'. Only 'openai' is supported.".format(
                custom_llm_provider
            ),
            model="n/a",
            llm_provider=custom_llm_provider,
...
def get_messages(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise llm.exceptions.BadRequestError(
            message="LLM doesn't support {} for 'get_messages'. Only 'openai' is supported.".format(
                custom_llm_provider
            ),
            model="n/a",
            llm_provider=custom_llm_provider,
...
def run_thread(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise llm.exceptions.BadRequestError(
            message="LLM doesn't support {} for 'run_thread'. Only 'openai' is supported.".format(
                custom_llm_provider
            ),
            model="n/a",
            llm_provider=custom_llm_provider,
