...
):  # llm wrapper on top of openai object for handling cached content
...
class ChatCompletionRequest(TypedDict, total=False):
    ...
    functions: List
    user: str
    metadata: dict  # llm specific param
...
class HanzoFineTuningJobCreate(FineTuningJobCreate):
...
class BaseHanzoOpenAIResponseObject(BaseModel):
...
class OutputTokensDetails(BaseHanzoOpenAIResponseObject):
    reasoning_tokens: int

    model_config = {"extra": "allow"}


class ResponseAPIUsage(BaseHanzoOpenAIResponseObject):
    input_tokens: int
...
class ResponsesAPIResponse(BaseHanzoOpenAIResponseObject):
    id: str
    created_at: float
    error: Optional[dict]
...
class ResponseCreatedEvent(BaseHanzoOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_CREATED]
    response: ResponsesAPIResponse


class ResponseInProgressEvent(BaseHanzoOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_IN_PROGRESS]
    response: ResponsesAPIResponse


class ResponseCompletedEvent(BaseHanzoOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_COMPLETED]
    response: ResponsesAPIResponse
    _hidden_params: dict = PrivateAttr(default_factory=dict)


class ResponseFailedEvent(BaseHanzoOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_FAILED]
    response: ResponsesAPIResponse


class ResponseIncompleteEvent(BaseHanzoOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_INCOMPLETE]
    response: ResponsesAPIResponse


class OutputItemAddedEvent(BaseHanzoOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.OUTPUT_ITEM_ADDED]
    output_index: int
    item: dict


class OutputItemDoneEvent(BaseHanzoOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.OUTPUT_ITEM_DONE]
    output_index: int
    item: dict


class ContentPartAddedEvent(BaseHanzoOpenAIResponseObject):
...
class ContentPartDoneEvent(BaseHanzoOpenAIResponseObject):
...
class OutputTextDeltaEvent(BaseHanzoOpenAIResponseObject):
...
class OutputTextAnnotationAddedEvent(BaseHanzoOpenAIResponseObject):
...
class OutputTextDoneEvent(BaseHanzoOpenAIResponseObject):
...
class RefusalDeltaEvent(BaseHanzoOpenAIResponseObject):
...
class RefusalDoneEvent(BaseHanzoOpenAIResponseObject):
...
class FunctionCallArgumentsDeltaEvent(BaseHanzoOpenAIResponseObject):
...
class FunctionCallArgumentsDoneEvent(BaseHanzoOpenAIResponseObject):
...
class FileSearchCallInProgressEvent(BaseHanzoOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.FILE_SEARCH_CALL_IN_PROGRESS]
    output_index: int
    item_id: str


class FileSearchCallSearchingEvent(BaseHanzoOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.FILE_SEARCH_CALL_SEARCHING]
    output_index: int
    item_id: str


class FileSearchCallCompletedEvent(BaseHanzoOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.FILE_SEARCH_CALL_COMPLETED]
    output_index: int
    item_id: str


class WebSearchCallInProgressEvent(BaseHanzoOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.WEB_SEARCH_CALL_IN_PROGRESS]
    output_index: int
    item_id: str


class WebSearchCallSearchingEvent(BaseHanzoOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.WEB_SEARCH_CALL_SEARCHING]
    output_index: int
    item_id: str


class WebSearchCallCompletedEvent(BaseHanzoOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.WEB_SEARCH_CALL_COMPLETED]
    output_index: int
    item_id: str


class ErrorEvent(BaseHanzoOpenAIResponseObject):
