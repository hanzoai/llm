...
class LLMFineTuningJobCreate(FineTuningJobCreate):
...
class BaseLLMOpenAIResponseObject(BaseModel):
...
class OutputTokensDetails(BaseLLMOpenAIResponseObject):
    reasoning_tokens: int

    model_config = {"extra": "allow"}


class ResponseAPIUsage(BaseLLMOpenAIResponseObject):
    input_tokens: int
...
class ResponsesAPIResponse(BaseLLMOpenAIResponseObject):
    id: str
    created_at: float
    error: Optional[dict]
...
class ResponseCreatedEvent(BaseLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_CREATED]
    response: ResponsesAPIResponse


class ResponseInProgressEvent(BaseLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_IN_PROGRESS]
    response: ResponsesAPIResponse


class ResponseCompletedEvent(BaseLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_COMPLETED]
    response: ResponsesAPIResponse
    _hidden_params: dict = PrivateAttr(default_factory=dict)


class ResponseFailedEvent(BaseLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_FAILED]
    response: ResponsesAPIResponse


class ResponseIncompleteEvent(BaseLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_INCOMPLETE]
    response: ResponsesAPIResponse


class OutputItemAddedEvent(BaseLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.OUTPUT_ITEM_ADDED]
    output_index: int
    item: dict


class OutputItemDoneEvent(BaseLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.OUTPUT_ITEM_DONE]
    output_index: int
    item: dict


class ContentPartAddedEvent(BaseLLMOpenAIResponseObject):
...
class ContentPartDoneEvent(BaseLLMOpenAIResponseObject):
...
class OutputTextDeltaEvent(BaseLLMOpenAIResponseObject):
...
class OutputTextAnnotationAddedEvent(BaseLLMOpenAIResponseObject):
...
class OutputTextDoneEvent(BaseLLMOpenAIResponseObject):
...
class RefusalDeltaEvent(BaseLLMOpenAIResponseObject):
...
class RefusalDoneEvent(BaseLLMOpenAIResponseObject):
...
class FunctionCallArgumentsDeltaEvent(BaseLLMOpenAIResponseObject):
...
class FunctionCallArgumentsDoneEvent(BaseLLMOpenAIResponseObject):
...
class FileSearchCallInProgressEvent(BaseLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.FILE_SEARCH_CALL_IN_PROGRESS]
    output_index: int
    item_id: str


class FileSearchCallSearchingEvent(BaseLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.FILE_SEARCH_CALL_SEARCHING]
    output_index: int
    item_id: str


class FileSearchCallCompletedEvent(BaseLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.FILE_SEARCH_CALL_COMPLETED]
    output_index: int
    item_id: str


class WebSearchCallInProgressEvent(BaseLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.WEB_SEARCH_CALL_IN_PROGRESS]
    output_index: int
    item_id: str


class WebSearchCallSearchingEvent(BaseLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.WEB_SEARCH_CALL_SEARCHING]
    output_index: int
    item_id: str


class WebSearchCallCompletedEvent(BaseLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.WEB_SEARCH_CALL_COMPLETED]
    output_index: int
    item_id: str


class ErrorEvent(BaseLLMOpenAIResponseObject):
