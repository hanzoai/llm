...
class BudgetManager:
    ...
    def projected_cost(self, model: str, messages: list, user: str):
        ...
        prompt_tokens = llm.token_counter(model=model, text=text)
        prompt_cost, _ = llm.cost_per_token(
    ...
    def update_cost(
        ...
        if model and input_text and output_text:
            prompt_tokens = llm.token_counter(
            ...
            cost = llm.completion_cost(completion_response=completion_obj)
