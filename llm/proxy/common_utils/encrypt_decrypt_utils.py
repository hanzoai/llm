...
def _get_salt_key():
    from llm.proxy.proxy_server import master_key

    salt_key = os.getenv("LLM_SALT_KEY", None)

    if salt_key is None:
        verbose_proxy_logger.debug(
            "LLM_SALT_KEY is None using master_key to encrypt/decrypt secrets stored in DB"
        )
