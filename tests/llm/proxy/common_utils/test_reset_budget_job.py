...
def test_reset_budget_for_key(reset_budget_job, mock_prisma_client):
    ...
    # Run the test
    asyncio.run(reset_budget_job.reset_budget_for_llm_keys())
...
def test_reset_budget_for_user(reset_budget_job, mock_prisma_client):
    ...
    # Run the test
    asyncio.run(reset_budget_job.reset_budget_for_llm_users())
...
def test_reset_budget_for_team(reset_budget_job, mock_prisma_client):
    ...
    # Run the test
    asyncio.run(reset_budget_job.reset_budget_for_llm_teams())
