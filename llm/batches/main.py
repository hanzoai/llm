...
from llm.llms.azure.batches.handler import AzureBatchesAPI
from llm.llms.openai.openai import OpenAIBatchesAPI
from llm.llms.vertex_ai.batches.handler import VertexAIBatchPrediction
...
from llm.types.utils import HanzoBatch
from llm.utils import client, get_llm_params, supports_httpx_timeout
...
async def acreate_batch(
    ...
    **kwargs,
    ...
    Hanzo Equivalent of POST: https://api.openai.com/v1/batches
    """
    try:
    ...
    try:
        ...
        if custom_llm_provider == "openai":
            ...
            raise llm.exceptions.BadRequestError(
                message="Hanzo doesn't support custom_llm_provider={} for 'create_batch'".format(
                    custom_llm_provider
                ),
                model="n/a",
                ...
                response=httpx.Response(
                    ...
                    request=httpx.Request(method="create_batch", url="https://github.com/BerriAI/llm"),  # type: ignore
                ),
            )
        return response
    except Exception as e:
...
async def aretrieve_batch(
    ...
    **kwargs,
    ...
    Hanzo Equivalent of GET https://api.openai.com/v1/batches/{batch_id}
    """
    try:
        loop = asyncio.get_event_loop()
    ...
    **kwargs,
    ...
    try:
        ...
        if custom_llm_provider == "openai":
            ...
            raise llm.exceptions.BadRequestError(
                message="Hanzo doesn't support {} for 'create_batch'. Only 'openai' is supported.".format(
                    custom_llm_provider
                ),
                model="n/a",
                llm_provider=custom_llm_provider,
    ...
    **kwargs,
    ...
    try:
        ...
        if custom_llm_provider == "openai":
            ...
            raise llm.exceptions.BadRequestError(
                message="Hanzo doesn't support {} for 'list_batch'. Only 'openai' is supported.".format(
                    custom_llm_provider
                ),
                model="n/a",
                llm_provider=custom_llm_provider,
...
async def acancel_batch(
    ...
    **kwargs,
    ...
    Hanzo Equivalent of POST https://api.openai.com/v1/batches/{batch_id}/cancel
    """
    try:
        loop = asyncio.get_event_loop()
    ...
    **kwargs,
    ...
    try:
        ...
        if custom_llm_provider == "openai":
            ...
            raise llm.exceptions.BadRequestError(
                message="Hanzo doesn't support {} for 'cancel_batch'. Only 'openai' and 'azure' are supported.".format(
                    custom_llm_provider
                ),
                model="n/a",
                llm_provider=custom_llm_provider,
                response=httpx.Response(
                    status_code=400,
                    content="Unsupported provider",
                    request=httpx.Request(method="cancel_batch", url="https://github.com/BerriAI/llm"),  # type: ignore
                ),
            )
        return response
    except Exception as e:
