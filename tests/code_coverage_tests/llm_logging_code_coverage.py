...
def main():
    logging_file = "./llm/llm_core_utils/llm_logging.py"
    tests_dir = "./tests/"
    ...
    if untested_functions:
        ...
        raise Exception(
            f"{untested_perc * 100:.2f}% of functions in llm_logging.py are not tested: {untested_functions}"
        )
    else:
        print("All functions in llm_logging.py are covered by tests.")
